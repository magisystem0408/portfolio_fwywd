...
export default function Layout({children, title = "自己紹介"}) {
    ...
    return (
        <div className="">
            ...
            <header className="flex flex-col shadow-sm mb-1 md:mb-0 md:flex-row items-center md:justify-between px-3">
                <Image src={logo}
                       alt="ロゴ" width={160} height={80} className="object-contain"/>
                <nav>
                    <div className="text-t_green font-lato font-bold space-x-6 md:space-x-8 sm:text-sm md:text-lg">
